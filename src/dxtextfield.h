...
enum {
    SEL_LINK = SEL_LAST ///Link text clicked
};

class dxTextField : public FXFrame {
  FXDECLARE(dxTextField)
protected:
  FXString      contents;       // Edited text
  FXString      styles;         // Text style
...
public:
  ...
  dxTextField(FXComposite* p,FXint ncols,FXObject* tgt=NULL,FXSelector sel=0,FXuint opts=TEXTFIELD_NORMAL,FXint x=0,FXint y=0,FXint w=0,FXint h=0,FXint pl=DEFAULT_PAD,FXint pr=DEFAULT_PAD,FXint pt=DEFAULT_PAD,FXint pb=DEFAULT_PAD);
